...
class splashScreen(pygame.sprite.Sprite):
    ...
    def __init__(self, workSpace, pyBros_Logo, posX, posY):
        ...
        self.bar = pygame.Surface(((self.pyBrosLogo_width - 100) / 11, 40))
        self.actived()
    ...
    def animationBar(self):
        ...
        for i in range(11):
            self.workSpace.blit(self.bar, (self.position[0] + i*((self.pyBrosLogo_width - 100) / 11 + 10), self.position[1] + self.pyBrosLogo_height))
            pygame.display.flip()
